...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.8cm,
  ...
  \node[state]         (Tb) at (0, 0)              {Transformed beta};
  \node[state]         (GP) at (0, -3)           {Generalized Pareto};
  \node[state]         (P) at (0, -6)        {Pareto};
  \node[state]         (Bu) at (-5, -3)        {Bur};
  \node[state]         (log) at (-5, -6)        {Loglogistic};
  \node[state]         (plog) at (-5, 0)        {Paralogistic};
  \node[state]       (iBu) at (5, -3)        {Inverse Bur};
  \node[state]         (iP) at (5, -6)        {Inverse Pareto};
  \node[state]         (iplog) at (5, 0)        {Inverse Paralogistic};
  \node[state]         (TG) at (-4, 3)       {Transformed Gamma};
  \node[state]         (G) at (-2, 6)        {Gamma};
  \node[state]         (W) at (-6, 6)        {Weibull};
  \node[state]         (E) at (-4, 9)        {Exponential};
  \node[state]         (iTG) at (4, 3)       {Inverse Transformed Gamma};
  \node[state]         (iG) at (2, 6)        {Inverse Gamma};
  \node[state]         (iW) at (6, 6)        {Inverse Weibull};
  \node[state]         (iE) at (4, 9)        {Inverse Exponential};
  \node[state]         (N) at (0, 9)        {Normal};
  \node[state]         (LN) at (0, 3)        {Lognormal};
  \node[state]         (Chi) at (-2, 12)        {Chi-squre};
  \node[state]         (t) at (2, 12)        {t};
  \node[state]         (F) at (-6, 12)        {F};
